...
{	
    ...
    if (self)
    {
        ...
        _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 5, [[UIScreen mainScreen] bounds].size.width, 14)];
...
- (void)updateFramesForAuthorType:(AuthorType)type
{
    ...
    CGFloat bubbleYOffset = 15;
	if(type == STBubbleTableViewCellAuthorTypeSelf)
	{
		if(self.imageView.image)
		{
			self.bubbleView.frame = CGRectMake(self.frame.size.width - (size.width + STBubbleWidthOffset) - STBubbleImageSize - 8.0f, self.frame.size.height - (size.height + 15.0f)-bubbleYOffset, size.width + STBubbleWidthOffset, size.height + 15.0f);
			...
			self.textLabel.frame = CGRectMake(self.frame.size.width - (size.width + STBubbleWidthOffset - 10.0f) - STBubbleImageSize - 8.0f, self.frame.size.height - (size.height + 15.0f) + 6.0f-bubbleYOffset, size.width + STBubbleWidthOffset - 23.0f, size.height);
		}
		else
		{
			self.bubbleView.frame = CGRectMake(self.frame.size.width - (size.width + STBubbleWidthOffset), 0.0f-bubbleYOffset, size.width + STBubbleWidthOffset, size.height + 15.0f);
			self.imageView.frame = CGRectZero;
			self.textLabel.frame = CGRectMake(self.frame.size.width - (size.width + STBubbleWidthOffset - 10.0f), 6.0f-bubbleYOffset, size.width + STBubbleWidthOffset - 23.0f, size.height);
		}
	...
	else
	{
		if(self.imageView.image)
		{
			self.bubbleView.frame = CGRectMake(STBubbleImageSize + 8.0f, self.frame.size.height - (size.height + 15.0f)-bubbleYOffset, size.width + STBubbleWidthOffset, size.height + 15.0f);
			self.imageView.frame = CGRectMake(5.0, self.frame.size.height - STBubbleImageSize - 2.0f, STBubbleImageSize, STBubbleImageSize);
			self.textLabel.frame = CGRectMake(STBubbleImageSize + 8.0f + 16.0f, self.frame.size.height - (size.height + 15.0f) + 6.0f-bubbleYOffset, size.width + STBubbleWidthOffset - 23.0f, size.height);
		}
		else
		{
			self.bubbleView.frame = CGRectMake(0.0f, 0.0f-bubbleYOffset, size.width + STBubbleWidthOffset, size.height + 15.0f);
			self.imageView.frame = CGRectZero;
			self.textLabel.frame = CGRectMake(16.0f, 6.0f-bubbleYOffset, size.width + STBubbleWidthOffset - 23.0f, size.height);
		}
