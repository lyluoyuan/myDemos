...
class CustomEmojiView: UIView,UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    init(textField:UITextField!,delegate:CustomEmojiViewDelegate!){
        super.init(frame: CGRectZero)
        rawInputView = textField.inputView

        self.textView = textField
        self.frame = CGRectMake(0,0,screenWidth,515/1334*screenHeight)
        self.backgroundColor = UIColor.hex("#e9ecec")
        ...
        pageControl.currentPageIndicatorTintColor = headerBgColor
